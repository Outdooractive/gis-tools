...
extension FeatureCollection {
    ...
    public func enumerateCoordinates(
        _ callback: (_ featureIndex: Int, _ coordinateIndex: Int, _ coordinate: Coordinate3D) -> Void
    )  {
...
extension Feature {
    ...
    /// - Parameter callback: The callback function
    public func enumerateCoordinates(
        _ callback: (_ coordinateIndex: Int, _ coordinate: Coordinate3D) -> Void
    )  {
...
extension GeometryCollection {
    ...
    /// - Parameter callback: The callback function
    public func enumerateCoordinates(
        _ callback: (_ geometryIndex: Int, _ coordinateIndex: Int, _ coordinate: Coordinate3D) -> Void
    ) {
