...
final class ReverseTests: XCTestCase {
    ...
    func testLineString() {
        ...
        XCTAssertEqual(lineStringReversed.allCoordinates().map({ $0.latitude }), [5.0, 4.0, 3.0, 2.0, 1.0, 0.0])
        ...
        XCTAssertEqual(multiLineStringReversed.lineStrings[0].allCoordinates().map({ $0.latitude }), [5.0, 4.0, 3.0, 2.0, 1.0, 0.0])
        XCTAssertEqual(multiLineStringReversed.lineStrings[1].allCoordinates().map({ $0.latitude }), [5.0, 4.0, 3.0, 2.0, 1.0, 0.0])
    }
    ...
    func testFeatureCollection() {
        ...
        XCTAssertEqual((reversed.features[1].geometry as? MultiLineString)?.lineStrings[0].allCoordinates().map({ $0.latitude }), [5.0, 4.0, 3.0, 2.0, 1.0, 0.0])
        XCTAssertEqual((reversed.features[1].geometry as? MultiLineString)?.lineStrings[1].allCoordinates().map({ $0.latitude }), [5.0, 4.0, 3.0, 2.0, 1.0, 0.0])
